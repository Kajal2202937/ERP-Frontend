  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div style={{ textAlign: "center", marginBottom: "1.5rem", paddingTop: "0.25rem" }}>
          {!sent ? (
            <>
              <div style={{
              ...
              <p style={{ fontSize: "0.9rem", color: "var(--text3, #888)", margin: 0, lineHeight: 1.5 }}>
            ...
            <>
              <div style={{
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="#3ecf8e" strokeWidth="2.5"
                     strokeLinecap="round" strokeLinejoin="round"
              ...
              <p style={{ fontSize: "0.9rem", color: "var(--text3, #888)", margin: 0,
                          lineHeight: 1.5 }}>
